...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `prodvana` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-prodvana
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-prodvana/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-prodvana/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-prodvana_darwin_amd64_v1
│   └── pulumi-resource-prodvana
├── pulumi-prodvana_darwin_arm64
│   └── pulumi-resource-prodvana
├── pulumi-prodvana_linux_amd64_v1
│   └── pulumi-resource-prodvana
├── pulumi-prodvana_linux_arm64
│   └── pulumi-resource-prodvana
├── pulumi-prodvana_windows_amd64_v1
│   └── pulumi-resource-prodvana.exe
└── pulumi-prodvana_windows_arm64
    └── pulumi-resource-prodvana.exe
```
