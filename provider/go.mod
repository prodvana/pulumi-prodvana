module github.com/prodvana/pulumi-prodvana/provider
...
require (
	github.com/prodvana/terraform-provider-prodvana v0.1.18
...
require (
	...
	github.com/prodvana/prodvana-public/go/prodvana-sdk v0.3.9 // indirect
