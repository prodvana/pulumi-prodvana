...
func NewProvider(ctx *pulumi.Context,
	...
	if args.OrgSlug == nil {
		if d := internal.GetEnvOrDefault(nil, nil, "PVN_ORG_SLUG"); d != nil {
			args.OrgSlug = pulumi.StringPtr(d.(string))
		}
	}
	if args.ApiToken != nil {
	...
	err := ctx.RegisterResource("pulumi:providers:prodvana", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Prodvana organization to authenticate with (you can find this in your Org's url: <org>.prodvana.io)
func (o ProviderOutput) OrgSlug() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringPtrOutput { return v.OrgSlug }).(pulumi.StringPtrOutput)
}
