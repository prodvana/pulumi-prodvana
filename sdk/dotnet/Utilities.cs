...
namespace Pulumi.Prodvana
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/prodvana";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Prodvana.version.txt");
    ...
    internal sealed class ProdvanaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ProdvanaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
