...
namespace Pulumi.Prodvana.Inputs
{
    ...
    public sealed class GetReleaseChannelConvergenceProtectionRefParameterInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretValue")]
        public Input<Inputs.GetReleaseChannelConvergenceProtectionRefParameterSecretValueInputArgs>? SecretValue { get; set; }
        ...
        public GetReleaseChannelConvergenceProtectionRefParameterInputArgs()
        {
        }
        public static new GetReleaseChannelConvergenceProtectionRefParameterInputArgs Empty => new GetReleaseChannelConvergenceProtectionRefParameterInputArgs();
    }
}
