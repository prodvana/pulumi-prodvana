...
namespace Pulumi.Prodvana.Inputs
{
    ...
    public sealed class ReleaseChannelProtectionRefParameterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretValue")]
        public Input<Inputs.ReleaseChannelProtectionRefParameterSecretValueArgs>? SecretValue { get; set; }
        ...
        public ReleaseChannelProtectionRefParameterArgs()
        {
        }
        public static new ReleaseChannelProtectionRefParameterArgs Empty => new ReleaseChannelProtectionRefParameterArgs();
    }
}
