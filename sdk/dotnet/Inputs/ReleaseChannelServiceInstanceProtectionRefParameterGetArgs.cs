...
namespace Pulumi.Prodvana.Inputs
{
    ...
    public sealed class ReleaseChannelServiceInstanceProtectionRefParameterGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretValue")]
        public Input<Inputs.ReleaseChannelServiceInstanceProtectionRefParameterSecretValueGetArgs>? SecretValue { get; set; }
        ...
        public ReleaseChannelServiceInstanceProtectionRefParameterGetArgs()
        {
        }
        public static new ReleaseChannelServiceInstanceProtectionRefParameterGetArgs Empty => new ReleaseChannelServiceInstanceProtectionRefParameterGetArgs();
    }
}
