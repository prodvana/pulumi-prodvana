...
namespace Pulumi.Prodvana.Inputs
{
    ...
    public sealed class GetReleaseChannelProtectionRefParameterInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("secretValue")]
        public Input<Inputs.GetReleaseChannelProtectionRefParameterSecretValueInputArgs>? SecretValue { get; set; }
        ...
        public GetReleaseChannelProtectionRefParameterInputArgs()
        {
        }
        public static new GetReleaseChannelProtectionRefParameterInputArgs Empty => new GetReleaseChannelProtectionRefParameterInputArgs();
    }
}
